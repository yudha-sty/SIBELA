    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/modal".
                    aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                        class="hide-menu">Modal
                    </span></a>
                </li>
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/jasa".
                    aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                ...
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="/ph".
                    aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
